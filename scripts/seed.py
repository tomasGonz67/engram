...
MEMORIES = [
    ...
    "My cat knocked a glass off the counter",
    "Took my dog for a long walk in the park",
    "My hamster escaped its cage and I found it under the couch",
    "Bought a new scratching post for my cat",
    "My dog learned how to shake paws",
    "Watched my fish swim around the new tank",
    "My parrot said its first word",
    "Took my dog to the vet for a checkup",
    "My cat has been sleeping more than usual",
    ...
    "My dog got groomed for the first time",
    ...
    # Work (20)
    "Had a long meeting about the quarterly budget",
    ...
    "The team shipped a major feature release",
    ...
    "Led my first sprint planning meeting",

    # Food / hobbies (15)
    "Tried a new recipe for homemade pasta",
    "Went hiking on a new trail",
    ...
    "Met my girlfriend playing Toontown",
    "Played Roblox with my girlfriend for hours",
    "My girlfriend and I started a new true crime series on Netflix",
    "Watched police body cam videos on YouTube with my girlfriend",
    ...
    "Had a really vivid dream about flying",
